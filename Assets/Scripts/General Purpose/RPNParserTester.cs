...
public class RPNParserTester : MonoBehaviour
{
    ...
    private void TestSimpleExpressions()
    {
        ...
        Debug.Log("Test 0 (5): " + RPNParser.Instance.DoParse("5")); // Expected 5
        //test for addition operator
        Debug.Log("Test 1 (5 3 +): " + RPNParser.Instance.DoParse("5 3 +")); // Expected: 8
        //test for subtraction operator
        Debug.Log("Test 2 (6 4 -): " + RPNParser.Instance.DoParse("6 4 -")); // Expected: 2
        //test for multiplication operator
        Debug.Log("Test 3 (3 5 *): " + RPNParser.Instance.DoParse("3 5 *")); // Expected: 15
        //test for modulo operator
        Debug.Log("Test 4 (7 3 %): " + RPNParser.Instance.DoParse("7 3 %")); // Expected: 1
        //test for division operator
        Debug.Log("Test 5 (10 2 /): " + RPNParser.Instance.DoParse("10 2 /")); // Expected: 5
    ...
    private void TestExpressionsWithVariables()
    {
        ...
        Debug.Log("Test 0 (base 5 wave * +): " + RPNParser.Instance.DoParse("base 5 wave * +", vars)); // Expected: 35
        Debug.Log("Test 1 (base wave + 2 *): " + RPNParser.Instance.DoParse("base wave + 2 *", vars)); // ((20)+(3))*2 = 46
        Debug.Log("Test 2 (wave base /): " + RPNParser.Instance.DoParse("wave base /", vars)); // (3)/(20) = 0.15
    }
}
